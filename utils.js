...
document.querySelector("head").append((() => { let style = document.createElement("link"); style.rel = "stylesheet"; style.href = "style.css?v=" + Date.now(); console.log(style); return style; })());
